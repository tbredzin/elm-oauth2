...
var $author$project$OAuth$AuthorizationCode$PKCE$codeVerifierFromBytes = function (bytes) {
	return (($elm$bytes$Bytes$width(bytes) < 32) || ($elm$bytes$Bytes$width(bytes) > 90)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		$ivadzy$bbase64$Base64$Encode$bytes(bytes));
};
		...
		A2(
			...
			A2(
				...
				function (_v0) {
					var clientId = _v0.O;
					var secret = _v0.bd;
					return $ivadzy$bbase64$Base64$Encode$encode(
						$ivadzy$bbase64$Base64$Encode$string(clientId + (':' + secret)));
				},
				credentials)));
};
...
var $author$project$OAuth$AuthorizationCode$PKCE$mkCodeChallenge = A2(
	...
	A2(
		...
		A2(
			...
			A2($elm$core$Basics$composeR, $ivadzy$bbase64$Base64$Encode$bytes, $elm$core$Basics$identity))));
